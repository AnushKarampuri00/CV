...
|-------|------|--------|
| LDHC Inhibitor Discovery | Male contraception | Deep learning, virtual screening, SHAP |
| Drug Response Prediction (M.Tech) | Breast cancer | QSAR, ML/DL, drug repurposing |
| NSP-14 Inhibitors (B.Tech) | SARS-CoV-2 | Structure-based screening, Schrödinger |
...
|----|------------|------|
| Teaching Assistant – Drug & Vaccine Informatics | NIT Warangal | 2024 |
| Teaching Assistant – Biocomputing Lab | NIT Warangal | 2023 |
| Technical Association Member (TAB) | NIT Warangal | 2022–23 |
| NSS Volunteer | KL University | 2020 |